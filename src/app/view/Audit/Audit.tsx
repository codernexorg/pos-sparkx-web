    ...
    return (
        <div className={"mt-4"}>
            ...
            <div className={"space-x-2"}>
                        ...
                        printJS(
                            {
                                printable: products.map(item => ({
                                    ...
                                    htmlProductGroup: `<p style="margin: 0">${item.productGroup}</p><p style="margin: 0;">${item.itemCode}</p>`,
                                })),
                                properties: [
                                ...
                                header: `<h5 style="margin: 0;padding: 0;text-align: center">Audit Data (${products[0].showroomName})</h5> <p style="margin: 0;padding: 0;text-align: center">${new Date(Date.now()).toLocaleTimeString('en', {
                                    day: 'numeric',
                                    month: 'short',
                                    year: 'numeric'
                                })}</p>`,
                                type: 'json',
                                gridStyle: 'width:fit-content;font-size: 12px;font-family: sans-serif;border: 1px solid #ccc',
                                targetStyle: ['border'],
                                showModal: true,
                                gridHeaderStyle: 'font-size: 12px;font-family: sans-serif;border: 1px solid #ccc;width:fit-content',
                ...
                <Button className={"bg-red-900 text-white"} type={"primary"} onClick={() => {
                    const doc=new JsPDF()
                    autoTable(doc,{
                        html:'auditData',
                        startY:20
