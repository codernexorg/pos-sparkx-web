...
const Purchase: React.FC<PurchaseProps> = () => {
  ...
  return (
    <PrintAbleLayout title={'Purchases'} showPrint={false} showPDF={false} showExcel={false}>
      <Table dataSource={purchases} loading={isLoading} rowClassName={'dark:bg-slate-700 dark:text-white dark:hover:text-primaryColor-900'}>
        <Table.Column
          title='SL'
