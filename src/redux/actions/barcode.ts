...
export const printBarcode =
    (data: { lotNumber: number }) => async (dispatch: Dispatch<BarcodeActionType>) => {
...
export const createBarcodeSetting = (data: any) => async (dispatch: Dispatch<BarcodeActionType>) => {
    dispatch({type: 'CREATE_BARCODE_LOADING'});
    api.post('/barcode', data).then(res => {
...
export const fetchBarcode = () => async (dispatch: Dispatch<BarcodeActionType>) => {
    dispatch({type: 'FETCH_BARCODE_LOADING'});
    api.get('/barcode').then(res => {
...
export const getDefaultBarcode = () => async (dispatch: Dispatch<BarcodeActionType>) => {
    dispatch({type: 'GET_DEFAULT_BARCODE_LOADING'});
    api.get('/barcode/default').then(res => {
...
export const setDefaultBarcode = (id: number) => async (dispatch: Dispatch<BarcodeActionType>) => {
    dispatch({type: 'SET_DEFAULT_BARCODE_LOADING'});
    api.post(`/barcode/default/${id}`).then(res => {
...
export const updateBarcodeSetting = (id: number, data: any) => async (dispatch: Dispatch<BarcodeActionType>) => {
    dispatch({type: 'UPDATE_BARCODE_LOADING'});
    api.patch(`/barcode/${id}`, data).then(res => {
...
export const deleteBarcodeSetting = (id: number) => async (dispatch: Dispatch<BarcodeActionType>) => {
    dispatch({type: 'DELETE_BARCODE_LOADING'});
    api.delete(`/barcode/${id}`).then(res => {
